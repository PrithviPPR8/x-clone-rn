      ...
      >
        ...
        <View className="px-4 pb-4 border-b border-gray-100">
          ...
          <View className="mb-4">
            ...
            {/* <Text className="text-gray-900 mb-3">Hala Madrid</Text> */}
            <Text className="text-gray-900 mb-3">{currentUser.bio}</Text>

            <View className="flex-row items-center mb-2">
              <Feather name="map-pin" size={16} color="#657786" />
              {/* <Text className="text-gray-500 ml-2">Satara</Text> */}
              <Text className="text-gray-500 ml-2">{currentUser.location}</Text>
            </View>

            <View className="flex-row items-center mb-3">
              <Feather name="calendar" size={16} color="#657786" />
              {/* <Text className="text-gray-500 ml-2">Joined March 2025</Text> */}
            ...
            <View className="flex-row">
              ...
              <TouchableOpacity>
                <Text className="text-gray-900">
                  <Text className="font-bold">2M</Text>
