...
const PostCard = ({ post, currentUser, isLiked, onLike, onDelete, onComment }: PostCardProps) => {
        ...
        <View className="flex-1">
            ...
            {post.image && (
                <Image 
                    ...
                    // className="w-full h-48 rounded-2xl mb-3"    //this works for 16:9 aspect ratio (refer useCreatePosts.ts from hooks folder)
                    className="w-[300px] h-[375px] rounded-2xl mb-3 mr-2"  //working correctly for 4:5 aspect ratio
                    // resizeMode="cover"
                />
            )}
